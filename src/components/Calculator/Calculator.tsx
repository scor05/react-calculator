...
function Calculator({ currNum, setCurrNum, oldNum, setOldNum, currOp,
    setCurrOp, errText, setErrText, settings }: CalculatorProps) {
    const stateProps = {
    ...
    return <div className="calculator">
        <Display text={displayText} config={settings} />
        <Keyboard {...stateProps} />
    </div>
}
